...
async function apiRequest(){ //promise
    const alienName = document.querySelector('input').value //get the content fron the input field and assign it to alienName
    try{
        const response = await fetch(`https://star-trek-api-007.herokuapp.com/api/${alienName}`)
